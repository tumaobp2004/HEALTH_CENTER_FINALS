...
namespace PRE_DEFENSE {
    ...
    public partial class PatientDatabaseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class PatientsDataTable : global::System.Data.TypedTableBase<PatientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PatientsRow AddPatientsRow(string First_Name, string Last_Name, int Age, string Gender, string Civil_Status, string Address, string Type_Of_ID, string ID_Number, System.DateTime Date_Time) {
...
namespace PRE_DEFENSE.PatientDatabaseDataSet1TableAdapters {
    ...
    public partial class PatientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Patients` (`First_Name`, `Last_Name`, `Age`, `Gender`, `Civil_Status" +
                "`, `Address`, `Type_Of_ID`, `ID_Number`, `Date_Time`) VALUES (?, ?, ?, ?, ?, ?, " +
                "?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Patients` SET `First_Name` = ?, `Last_Name` = ?, `Age` = ?, `Gender` = ?, `Civil_Status` = ?, `Address` = ?, `Type_Of_ID` = ?, `ID_Number` = ?, `Date_Time` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `First_Name` IS NULL) OR (`First_Name` = ?)) AND ((? = 1 AND `Last_Name` IS NULL) OR (`Last_Name` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age` = ?)) AND ((? = 1 AND `Gender` IS NULL) OR (`Gender` = ?)) AND ((? = 1 AND `Civil_Status` IS NULL) OR (`Civil_Status` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Type_Of_ID` IS NULL) OR (`Type_Of_ID` = ?)) AND ((? = 1 AND `ID_Number` IS NULL) OR (`ID_Number` = ?)) AND ((? = 1 AND `Date_Time` IS NULL) OR (`Date_Time` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, First_Name, Last_Name, Age, Gender, Civil_Status, Address, Type_Of_ID," +
                " ID_Number, Date_Time FROM Patients";
        ...
        public virtual int Fill(PatientDatabaseDataSet1.PatientsDataTable dataTable) {
        ...
        public virtual PatientDatabaseDataSet1.PatientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PatientDatabaseDataSet1.PatientsDataTable dataTable = new PatientDatabaseDataSet1.PatientsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PatientDatabaseDataSet1.PatientsDataTable dataTable) {
        ...
        public virtual int Insert(string First_Name, string Last_Name, global::System.Nullable<int> Age, string Gender, string Civil_Status, string Address, string Type_Of_ID, string ID_Number, global::System.Nullable<global::System.DateTime> Date_Time) {
            if ((First_Name == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_Date_Time.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[27].Value = ((System.DateTime)(Original_Date_Time.Value));
            }
            else {
