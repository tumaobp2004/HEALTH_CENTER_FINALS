...
namespace PRE_DEFENSE
{
    public partial class AddConsultation : Form
    {
        ...
        public AddConsultation(string loggedInUsername)
        {
            InitializeComponent();
        ...
        private void AddConsultation_Load(object sender, EventArgs e)
        {
            PopulatePatientComboBox(); // Populating the ComboBox with patient data
            LoadCheckupData();
            PopulateMedicineComboBox(); // Populate Medicine ComboBox

            // Automatically set the Consultation Date to the current Date and Time
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT INTO Checkup ([PatientID], [MidWife], [Diagnosis], [Complaint], [Treatments], [Remarks], [TypeOfCheckUp], [MedicineName], [Quantity], [ConsultationDate]) " +
                                   "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                    ...
                    using (OleDbCommand cmd = new OleDbCommand(query, conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("?", dtpConsultationDate); // Automatically add current date and time
        ...
        private void ClearInputs()
        {
            ...
            dtpConsultationDate.Enabled = false; // Ensure the DateTimePicker is still non-editable
